...
const
   ...
   SCM_AFTERSCROLL_NOMINATE = WM_USER + 12; // currently (2025.11.13) not in use.
   SCM_AFTERSCROLL_FILTERMEMBER = WM_USER + 13;
   SCM_CONNECT = WM_USER + 14;
   SCM_DISCONNECT = WM_USER + 15;
   SCM_SCROLL_EVENTTYPE = WM_USER + 16; // INDV or TEAM
...
/// </Remarks>
 ...
 scmGroupByType = (agNone = 0, agCustom = 1, agSCM = 2);
