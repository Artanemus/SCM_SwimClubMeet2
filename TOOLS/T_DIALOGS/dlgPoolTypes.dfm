object PoolTypes: TPoolTypes
  ...
  object tblPoolType: TFDTable
    ...
    Left = 240
    Top = 208
    object tblPoolTypePoolTypeID: TFDAutoIncField
      FieldName = 'PoolTypeID'
      Origin = 'PoolTypeID'
      ProviderFlags = [pfInWhere, pfInKey]
    end
    object tblPoolTypeCaption: TWideStringField
      FieldName = 'Caption'
      Origin = 'Caption'
      Size = 128
    end
    object tblPoolTypeCaptionShort: TWideStringField
      FieldName = 'CaptionShort'
      Origin = 'CaptionShort'
      Size = 16
    end
    object tblPoolTypeABREV: TWideStringField
      FieldName = 'ABREV'
      Origin = 'ABREV'
      Size = 5
    end
    object tblPoolTypeIsShortCourse: TBooleanField
      FieldName = 'IsShortCourse'
      Origin = 'IsShortCourse'
      Required = True
    end
    object tblPoolTypeLengthOfPool: TFloatField
      FieldName = 'LengthOfPool'
      Origin = 'LengthOfPool'
    end
    object tblPoolTypeIsArchived: TBooleanField
      FieldName = 'IsArchived'
      Origin = 'IsArchived'
      Required = True
    end
    object tblPoolTypeUnitTypeID: TIntegerField
      FieldName = 'UnitTypeID'
      Origin = 'UnitTypeID'
    end
    object tblPoolTypeluUnitTypeID: TStringField
      FieldKind = fkLookup
      FieldName = 'luUnitTypeID'
      LookupDataSet = tblUnitType
      LookupKeyFields = 'UnitTypeID'
      LookupResultField = 'Caption'
      KeyFields = 'UnitTypeID'
      Lookup = True
    end
  end
