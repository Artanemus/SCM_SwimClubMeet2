  ...
  object qryNom_LookUp: TFDQuery
    ...
    Indexes = <
      ...
      item
        ...
        Name = 'indxLastName'
        Fields = 'LastName'
        CaseInsFields = 'LastName'
      end>
    IndexName = 'indxFirstName'
    ...
    SQL.Strings = (
      ...
      'DECLARE @SortOn AS BIT;'
      ''
      'SET @EventID = :EVENTID;'
      
        'SET @SortOn = :SORTON;   -- 0 (false)  = firstname  : 1 (true) =' +
        ' lastname'
      ''
      'SELECT [NomineeID]'
      '      ,[AGE]'
      ...
      #9#9'CASE '
        ...
        #9#9'WHEN ([Member].MiddleName IS NULL) OR ([Member].MiddleName = '#39 +
        #39') THEN'
      #9#9#9'CONCAT([Member].FirstName, '#39' '#39', UPPER([Member].LastName))'
      #9#9'ELSE'
      
        #9#9#9'CONCAT([Member].FirstName, '#39' '#39', LEFT([Member].MiddleName,1), ' +
        #39'. '#39', UPPER([Member].LastName))'
      #9#9'END '
      #9'ELSE'#9
      #9#9'CASE '
        ...
        #9#9'WHEN ([Member].MiddleName IS NULL) OR ([Member].MiddleName = '#39 +
        #39') THEN'
      #9#9#9'CONCAT(UPPER([Member].LastName), '#39', '#39', [Member].FirstName)'
      #9#9'ELSE'
      
        #9#9#9'CONCAT(UPPER([Member].LastName), '#39', '#39', [Member].FirstName, '#39'.' +
        ' '#39', LEFT([Member].MiddleName, 1) )'
      #9#9'END '#9
      #9'END'#9'as FName'
      '        ,[Member].LastName'
      '        ,[Member].FirstName  '
    ...
    object qryNom_LookUpNomineeID: TFDAutoIncField
      FieldName = 'NomineeID'
      Origin = 'NomineeID'
      ProviderFlags = [pfInWhere, pfInKey]
    end
    object qryNom_LookUpFName: TWideStringField
    ...
    object qryNom_LookUpAGE: TIntegerField
      FieldName = 'AGE'
      Origin = 'AGE'
    end
    ...
    object qryNom_LookUpMemberID: TIntegerField
      FieldName = 'MemberID'
      Origin = 'MemberID'
    end
    object qryNom_LookUpLastName: TWideStringField
      FieldName = 'LastName'
      Origin = 'LastName'
      Size = 128
    end
    object qryNom_LookUpFirstName: TWideStringField
      FieldName = 'FirstName'
      Origin = 'FirstName'
      Size = 128
    end
