...
const
  ...
  SCM_MEMBER_FILTER_CHANGED = WM_USER +109;
  SCM_MEMBER_FILTER_SWIMCLUB = WM_USER +110;
  SCM_MEMBER_FILTER_ARCHIVED = WM_USER +110;
  SCM_MEMBER_FILTER_ISACTIVE = WM_USER +110;
  SCM_MEMBER_FILTER_ISSWIMMER = WM_USER +110;
